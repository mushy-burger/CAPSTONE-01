...
if (!in_array('--confirm', $argv, true)) {
    echo "Safety check: rerun with --confirm to create a backup and delete approved operational data.\n";
...
$backupFile = $backupDir . "/{$database}_operational_backup_{$timestamp}.sql";
...
try {
    ...
    echo "Deleting approved operational data with DELETE statements...\n";
    ...
    fwrite(STDERR, "\nCleanup failed. Any transaction changes were rolled back.\n");
