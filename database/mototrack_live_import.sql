...
CREATE TABLE `booking_deposits` (
  ...
  KEY `user_id` (`user_id`),
  KEY `status` (`status`),
  CONSTRAINT `fk_booking_deposits_booking` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_booking_deposits_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
INSERT INTO `notification_log` VALUES (47,113,5,'appointment_confirmed','sms','09922550043','mocean','sent','FaresDawoud0830005346050807.0006',NULL,'2026-08-30 00:53:47'),(48,113,5,'appointment_confirmed','email','pippo.fares@gmail.com','php-mail','failed',NULL,'The mail server rejected or could not queue the message.','2026-08-30 00:53:49'),(49,91,5,'job_completed','sms','09922550043','mocean','sent','FaresDawoud0830005457057191.0006',NULL,'2026-08-30 00:54:58'),(50,91,5,'job_completed','email','pippo.fares@gmail.com','php-mail','failed',NULL,'The mail server rejected or could not queue the message.','2026-08-30 00:55:00'),(51,114,5,'appointment_confirmed','sms','09922550043','mocean-dry-run','sent','dryrun-077b421f916fa81a',NULL,'2026-08-30 00:58:23'),(52,114,5,'appointment_confirmed','email','pippo.fares@gmail.com','php-mail','failed',NULL,'The mail server rejected or could not queue the message.','2026-08-30 00:58:25'),(53,114,5,'job_completed','sms','09922550043','mocean-dry-run','sent','dryrun-993f6659bbd18f63',NULL,'2026-08-30 00:58:46'),(54,114,5,'job_completed','email','pippo.fares@gmail.com','php-mail','failed',NULL,'The mail server rejected or could not queue the message.','2026-08-30 00:58:48'),(55,115,5,'appointment_confirmed','sms','09922550043','mocean','sent','FaresDawoud0830005950966857.0005',NULL,'2026-08-30 00:59:50'),(56,115,5,'appointment_confirmed','email','pippo.fares@gmail.com','php-mail','failed',NULL,'The mail server rejected or could not queue the message.','2026-08-30 00:59:52'),(57,116,5,'appointment_confirmed','sms','09922550043','mocean','sent','FaresDawoud0830010139039607.0004',NULL,'2026-08-30 01:01:39'),(58,116,5,'appointment_confirmed','email','pippo.fares@gmail.com','php-mail','failed',NULL,'The mail server rejected or could not queue the message.','2026-08-30 01:01:41'),(59,116,5,'job_completed','sms','09922550043','mocean','sent','FaresDawoud0830010206041605.0004',NULL,'2026-08-30 01:02:07'),(60,116,5,'job_completed','email','pippo.fares@gmail.com','php-mail','failed',NULL,'The mail server rejected or could not queue the message.','2026-08-30 01:02:09');
...
INSERT INTO `site_settings` VALUES ('hero_background_image','hero_background_image.png'),('hero_eyebrow','Parts, accessories, and maintenance'),('hero_heading','Keep your motorcycle ready for every ride.'),('hero_image','hero_image_1782488480.jpg'),('hero_subtext','BUILT FOR THE RACE'),('reservation_deposit_amount','200.00');
...
INSERT INTO `technician_services` VALUES (67,8,34,'2026-07-16 18:09:41'),(68,8,35,'2026-07-16 18:09:41'),(69,8,33,'2026-07-16 18:09:41'),(70,8,36,'2026-07-16 18:09:41'),(71,8,37,'2026-07-16 18:09:41'),(77,3,33,'2026-07-16 18:10:03'),(78,3,36,'2026-07-16 18:10:03'),(79,3,32,'2026-07-16 18:10:03'),(80,3,37,'2026-07-16 18:10:03'),(81,17,33,'2026-07-18 09:51:20'),(82,17,36,'2026-07-18 09:51:20'),(83,17,32,'2026-07-18 09:51:20'),(84,17,37,'2026-07-18 09:51:20'),(85,7,34,'2026-08-30 01:01:14'),(86,7,35,'2026-08-30 01:01:14'),(87,7,33,'2026-08-30 01:01:14'),(88,7,36,'2026-08-30 01:01:14'),(89,7,37,'2026-08-30 01:01:14');
